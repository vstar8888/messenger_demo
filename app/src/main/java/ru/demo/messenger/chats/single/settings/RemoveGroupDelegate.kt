...
internal class RemoveGroupDelegate(context: Context,
                                   private val callback: Callback
) : AbstractAdapterDelegate<RemoveGroupDelegate.Item, Any, RemoveGroupDelegate.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): Holder =
            Holder(inflater.inflate(R.layout.item_remove_group, parent, false)).apply {
                itemView.setOnClickListener {
                    callback.onRemoveGroupClick()
                }
            }
